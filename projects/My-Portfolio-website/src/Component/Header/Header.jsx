...
//   { title: "Experience", path: "experience", value: "02", delay: 0.2 },
//   { title: "Education", path: "education", value: "03", delay: 0.3 },
//   { title: "Skills", path: "skills", value: "04", delay: 0.4 },
//   { title: "Projects", path: "projects", value: "05", delay: 0.5 },
//   { title: "Contact", path: "email", value: "06", delay: 0.6 }
// ];
...
//       </div>
//       {show && (
//         <div className="md:hidden absolute top-20 left-0 w-full bg-black shadow-lg py-4">
...
//                     {item.value && "."}
//                   </span>
//                   <span className="uppercase tracking-wide text-start">{item.title}</span>
//                 </motion.p>
//               </Link>
//             ))}
//             <motion.a
