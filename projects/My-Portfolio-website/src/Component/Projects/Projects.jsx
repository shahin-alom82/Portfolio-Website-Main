...
const Projects = () => {
      return (
            <Container id={"projects"} className={"py-28 lg:px-0 md:px-32"}>
                  ...
                  <div className="w-full flex justify-center lg:justify-start lg:px-32">
                        <SectionTitle title={"Some Things I have Built"} titleNo={"03 ."} className="ml-4 lg:ml-32" />
                  </div>


                  {/* Project One */}
                  <div className="flex flex-col lg:flex-row gap-10 mt-10 lg:px-32 px-4">
                        {/* image */}
                        ...
                        <div className="text-end lg:-ml-20 z-50">
                  ...
                  {/* Project Two */}
                  <div className="flex flex-col lg:flex-row gap-10 mt-32 lg:px-32 px-4">
                  ...
                  {/* Project Three */}
                  <div className="flex flex-col lg:flex-row gap-10 mt-32 px-4 lg:px-32">
                        {/* image */}
                        ...
                        <div className="text-end lg:-ml-32 z-50">
                              <h1 className="text-designColor">Featured Project</h1>
                              <h1 className="lg:text-[27px] text-xl font-semibold mt-2">Online Market Place</h1>
                              <div className="">
                                    <p className="bg-[#112240] h-full px-8 p-6 lg:w-[500px] lg:ml-10 mt-6 rounded-lg">Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br /> Nesciunt et impedit veniam at animi similique recusandae ex <br />exercitationem qui facere.</p>
                              </div>
